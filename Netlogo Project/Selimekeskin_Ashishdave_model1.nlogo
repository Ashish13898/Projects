to setup
  ...
  ask patches
  [if random-float 100 < greendensity [ set pcolor green ]]

   ask patches
  [if random-float 100 < bluedensity [ set pcolor blue ]]

  ask patches
  [if (distancexy ( xcor-Object1 * max-pxcor) ( ycor-Object1 * max-pxcor)) < Object1Size [ set pcolor sky ]]

  ask patches
  [if (distancexy ( xcor-Object2 * max-pxcor) ( ycor-Object2 * max-pxcor)) < Object2Size [ set pcolor sky ]]
